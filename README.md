...
[![GitHub contributors](https://img.shields.io/github/contributors/ignition-api/8.0)](https://github.com/ignition-api/8.0/graphs/contributors)
...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/ignition-api/8.0/main.svg)](https://results.pre-commit.ci/latest/github/ignition-api/8.0/main)
[![Join us on GitHub discussions](https://img.shields.io/badge/github-discussions-informational)](https://github.com/ignition-api/8.0/discussions)
...
```bash
python2 -m pip install ignition-api==8.0.17.post6
```
...
You may also download the code targeted to your desired version from the [releases page](https://github.com/ignition-api/8.0/releases) and add it as a dependency to your scripting project.

#### Using as a dependency in PyCharm

To include ignition-api as a dependency in PyCharm, you will need to attach it to your project.

1. Clone the repo or download from [releases](https://github.com/ignition-api/8.0/releases)
...
This package includes supporting Inductive Automation's classes and interfaces. For more information, see documentation here: <https://files.inductiveautomation.com/sdk/javadoc/ignition80/8.0.14/index.html>.
...
This package includes supporting Jython classes and interfaces. For more information, see documentation here: <https://www.javadoc.io/doc/org.python/jython-standalone/2.7.1/index.html>.

#### system

This package includes all Ignition Scripting Functions. For more information, see documentation here: <https://docs.inductiveautomation.com/display/DOC80/Scripting+Functions>.
...
Up-to-date list of contributors can be found [here](https://github.com/ignition-api/8.0/graphs/contributors).

## License

See the [LICENSE](https://github.com/ignition-api/8.0/blob/HEAD/LICENSE).
